...
<div data-role="page" id="LandingPage">
    <div  data-role="main" class="ui-content" >
       ...
       <div style="top: 10%; position: absolute; width: 93%; text-align: center;">
            <p>YOU CALL YOURSELF</p>
        </div>

                    <div style="top: 30%; position: absolute; width: 93%;" data-theme="b">

        <a href="#.php" class="ui-btn" data-ajax="false" >advanturous</a>
            </div>
   ...
   <div style="top: 50%; position: absolute; width: 93%;" data-theme="b">
        ...
        <a href="#.php" class="ui-btn" data-ajax="false" >showy</a>
            </div>
               <div style="top: 60%; position: absolute; width: 93%;" data-theme="b">

        <a href="#.php" class="ui-btn" data-ajax="false" >shy</a>
            </div>
        ...
        <a href="onboarding5.php" data-ajax="false"  >SKIP</a>
            </div>
